...
def getparameter(_file):
    ...
    elif _file.find('instLumi') != -1: _par.append('tag_instLumi_PLOT')
...
def makeleg(_canvas):
    ...
    par2='eff'
    print 'par3 is', par2
    NUMleg = {'LooseID':'Loose Id','MediumID':'Medium Id','TightID':'Tight Id', 'tightID_all':'tightID_all', 'tightID_Glb':'tightID_Glb', 'tightID_PF':'tightID_PF', 'tightID_glbChi2':'tightID_glbChi2', 'tightID_glbValidMuHits':'tightID_glbValidMuHits', 'tightID_numberOfMatchedStations':'tightID_numberOfMatchedStations', 'tightID_dB':'tightID_dB', 'tightid_dzPV':'tightid_dzPV', 'tightID_tkValidPixelHits':'tightID_tkValidPixelHits', 'tightID_tkTrackerLay':'tightID_tkTrackerLay','tightID_tkValidPixelHits_tkTrackerLay':'tightID_tkValidPixelHits_tkTrackerLay','tightID_glbValidMuHits_numberOfMatchedStations':'tightID_glbValidMuHits_numberOfMatchedStations','tightID_glbChi2_dB_dzPV':'tightID_glbChi2_dB_dzPV','SoftID':'Soft Id','LooseRelIso':'Loose Iso','TightRelIso':'Tight Iso','tkRelIso5':'Tracker Iso','HighPtID':'Hight p_{T} Id','LooseRelTkIso':'Tracker Iso#leq0.1', 'TightIDHWW':'Tight Id HWW', 'SIP_4':'SIP #leq 4'}
    DENleg = {'genTracks':'','LooseID':'/Loose Id','MediumID':'/Medium Id','TightIDandIPCut':'/Tight Id','HighPtIDandIPCut':'/High-p_{T}Id', 'TightIDHWW':'Tight Id HWW', 'TrackerMuons':'Tracker muons', 'TightHWWCut':'Tight Id HWW'}
